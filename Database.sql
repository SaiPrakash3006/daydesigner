...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2023 at 02:07 PM
...
('root', '[{\"db\":\"vlits\",\"table\":\"todos1\"},{\"db\":\"vlits\",\"table\":\"creds\"},{\"db\":\"vlits\",\"table\":\"data\"},{\"db\":\"vlits\",\"table\":\"todos\"}]');
...
('root', 'vlits', 'creds', '{\"sorted_col\":\"`creds`.`unqid` ASC\"}', '2023-02-20 05:33:37'),
('root', 'vlits', 'data', '{\"CREATE_TIME\":\"2023-02-18 16:06:12\",\"col_order\":[0,1,2,3],\"col_visib\":[1,1,1,1]}', '2023-02-18 10:59:39');
...
('root', '2023-07-25 12:05:10', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `vlits`
--
CREATE DATABASE IF NOT EXISTS `vlits` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vlits`;
